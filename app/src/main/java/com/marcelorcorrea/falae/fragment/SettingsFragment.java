    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scanMode.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    //save that was checked
                    SharedPreferencesUtils.storeBooleanPreferences("scan_mode", true, getContext());
                    System.out.println("on");
                } else {
                    //save it is not checked
                    SharedPreferencesUtils.storeBooleanPreferences("scan_mode", false, getContext());
